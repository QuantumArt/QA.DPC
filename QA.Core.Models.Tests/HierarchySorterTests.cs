...
namespace QA.Core.Models.Tests
{
    ...
    public class HierarchySorterTests
    {
        ...
        public void Test_HierarchySorter_valid_Fields()
        {
            ...
            foreach (var item in root.GetField("Parameters").As<MultiArticleField>().GetArticles(null))
            {
        ...
        {
            return new HierarchySorter(new HierarchySorterParameter
            {
        ...
        public void Test_HierarchySorter_ConstructHierarchy()
        {
            ...
            var grandParent = result1[2].Node.GetField("Parent").As<SingleArticleField>().GetItem(null).GetField("Parent")?.As<SingleArticleField>()?.GetItem(null);
