namespace QA.ProductCatalog.ContentProviders
{
    ...
    public enum SettingsTitles
    {
        ...
        PRODUCT_VALIDATION_FAILED_FIELD_NAME,
        PRODUCT_PUBLICATION_FAILED_FIELD_NAME,
        PRODUCT_VALIDATION_MSG_FIELD_NAME,
        PRODUCT_VALIDATION_CONDITION_FIELD_NAME,
        NOTES_CONTENT_ID,
        ...
        MODIFIER_DATA_OPTION_ID, //Идентификатор модификатора "Дата-Опция"
        MODIFIER_GET_COUNTRIES_FROM_ZONE, // Идентификатор модификатора "Получать данные стран из зоны"        
        ...
        API_AUTHORIZATION_CONTENT_ID,
        PRODUCTVERSION_CHUNK_SIZE,
