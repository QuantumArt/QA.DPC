!(function(a, b) {
  ...
  function n(a) {
    if (null == a._isValid) {
      var b = m(a),
        c = ne.call(b.parsedDateParts, function(a) {
          return null != a;
        }),
        d =
          !isNaN(a._d.getTime()) &&
  ...
  function N(a) {
    var b = [];
    for (var c in a) b.push({ unit: c, priority: Be[c] });
    return (
      b.sort(function(a, b) {
  ...
  function X(a, b) {
    return a.isValid()
      ? ((b = Y(b, a.localeData())), (Ee[b] = Ee[b] || W(b)), Ee[b](a))
  ...
  function Y(a, b) {
    ...
    var d = 5;
    for (De.lastIndex = 0; d >= 0 && De.test(a); )
      (a = a.replace(De, c)), (De.lastIndex = 0), (d -= 1);
    return a;
  }
  function Z(a, b, c) {
    Xe[a] = z(b)
  ...
  function $(a, b) {
    return i(Xe, a) ? Xe[a](b._strict, b._locale) : new RegExp(_(a));
  }
  ...
  function fa(a, b) {
    return a
      ? c(this._months)
        ...
        : this._months[
            (this._months.isFormat || hf).test(b) ? "format" : "standalone"
          ][a.month()]
      : this._months;
  }
  function ga(a, b) {
    return a
      ? c(this._monthsShort)
        ...
        : this._monthsShort[hf.test(b) ? "format" : "standalone"][a.month()]
      : this._monthsShort;
  }
  function ha(a, b, c) {
    var d,
    ...
    return c
      ? "MMM" === b
        ? ((e = gf.call(this._shortMonthsParse, g)), e !== -1 ? e : null)
        : ((e = gf.call(this._longMonthsParse, g)), e !== -1 ? e : null)
      : "MMM" === b
      ? ((e = gf.call(this._shortMonthsParse, g)),
        e !== -1
          ? e
          : ((e = gf.call(this._longMonthsParse, g)), e !== -1 ? e : null))
      : ((e = gf.call(this._longMonthsParse, g)),
        e !== -1
          ? e
          : ((e = gf.call(this._shortMonthsParse, g)), e !== -1 ? e : null));
  }
  ...
  function ma(a) {
    return this._monthsParseExact
      ...
      : (i(this, "_monthsShortRegex") || (this._monthsShortRegex = lf),
  ...
  function na(a) {
    return this._monthsParseExact
      ...
      : (i(this, "_monthsRegex") || (this._monthsRegex = mf),
  ...
  function Ia(a, b, c) {
    ...
    return c
      ? "dddd" === b
        ? ((e = gf.call(this._weekdaysParse, g)), e !== -1 ? e : null)
        : "ddd" === b
        ? ((e = gf.call(this._shortWeekdaysParse, g)), e !== -1 ? e : null)
        : ((e = gf.call(this._minWeekdaysParse, g)), e !== -1 ? e : null)
      : "dddd" === b
      ? ((e = gf.call(this._weekdaysParse, g)),
        e !== -1
          ? e
          : ((e = gf.call(this._shortWeekdaysParse, g)),
            e !== -1
              ? e
              : ((e = gf.call(this._minWeekdaysParse, g)),
                e !== -1 ? e : null)))
      : "ddd" === b
      ? ((e = gf.call(this._shortWeekdaysParse, g)),
        e !== -1
  ...
  function Na(a) {
    return this._weekdaysParseExact
      ...
      : (i(this, "_weekdaysRegex") || (this._weekdaysRegex = sf),
  ...
  function Oa(a) {
    return this._weekdaysParseExact
      ...
      : (i(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = tf),
  ...
  function Pa(a) {
    return this._weekdaysParseExact
      ...
      : (i(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = uf),
  ...
  function Za(a) {
    ...
    if (!zf[a] && "undefined" != typeof module && module && module.exports)
      try {
        (b = vf._abbr),
          require("./locale/" + a),
  ...
  function _a(a, b) {
    if (null !== b) {
      ...
      if (((b.abbr = a), null != zf[a]))
        ...
        if (null == zf[b.parentLocale])
          return (
            Af[b.parentLocale] || (Af[b.parentLocale] = []),
            Af[b.parentLocale].push({ name: a, config: b }),
            null
          );
  ...
  function ab(a, b) {
    ...
    // pass null for config to unupdate, useful for tests
      ...
      null != zf[a] &&
        (null != zf[a].parentLocale
          ? (zf[a] = zf[a].parentLocale)
          : null != zf[a] && delete zf[a]);
    return zf[a];
  }
  // returns locale data
  function bb(a) {
    ...
    return (
      c &&
        ...
        ((b =
          c[$e] < 0 || c[$e] > 11
            ? $e
            : c[_e] < 1 || c[_e] > ea(c[Ze], c[$e])
            ? _e
            : c[af] < 0 ||
              c[af] > 24 ||
              (24 === c[af] && (0 !== c[bf] || 0 !== c[cf] || 0 !== c[df]))
            ? af
            : c[bf] < 0 || c[bf] > 59
            ? bf
            : c[cf] < 0 || c[cf] > 59
            ...
            ? df
            : -1),
        m(a)._overflowDayOfYear && (b < Ze || b > _e) && (b = _e),
        m(a)._overflowWeeks && b === -1 && (b = ef),
        m(a)._overflowWeekday && b === -1 && (b = ff),
        (m(a).overflow = b)),
      a
    );
  }
      ...
      for (
        d = hb(a),
          ...
          a._dayOfYear &&
            ...
            (a._a[$e] = c.getUTCMonth()),
            (a._a[_e] = c.getUTCDate())),
          b = 0;
        b < 3 && null == a._a[b];
        ++b
      )
  ...
  function jb(a) {
    ...
    if (((b = a._w), null != b.GG || null != b.W || null != b.E))
      (f = 1),
        ...
        // create now).
        (c = gb(b.GG, a._a[Ze], wa(sb(), 1, 4).year)),
        (d = gb(b.W, 1)),
        (e = gb(b.E, 1)),
        (e < 1 || e > 7) && (i = !0);
    else {
  ...
  function kb(b) {
    ...
    var c,
      ...
      i = h.length,
      j = 0;
    for (e = Y(b._f, b._locale).match(Ce) || [], c = 0; c < e.length; c++)
      (f = e[c]),
        (d = (h.match($(f, b)) || [])[0]),
    ...
    (m(b).charsLeftOver = i - j),
      ...
      // handle meridiem
      (b._a[af] = lb(b._locale, b._a[af], b._meridiem)),
      ib(b),
      db(b);
  }
  function lb(a, b, c) {
  ...
  function Db(b, c) {
    ...
    if (null != b) {
      if ("string" == typeof b) {
        if (((b = Ab(Ue, b)), null === b)) return this;
  ...
  function Wc() {
    var a = this._data;
    return (
      (this._milliseconds = Xf(this._milliseconds)),
      (this._days = Xf(this._days)),
      (this._months = Xf(this._months)),
      (a.milliseconds = Xf(a.milliseconds)),
      (a.seconds = Xf(a.seconds)),
      (a.minutes = Xf(a.minutes)),
      (a.hours = Xf(a.hours)),
      (a.months = Xf(a.months)),
      (a.years = Xf(a.years)),
      this
    );
  }
  ...
  function kd(a) {
    return void 0 === a ? lg : "function" == typeof a && ((lg = a), !0);
  }
  // This function allows you to set a threshold for relative time strings
  function ld(a, b) {
    return void 0 !== mg[a] && (void 0 === b ? mg[a] : ((mg[a] = b), !0));
  }
  function md(a) {
  ...
  function Fd(a) {
    return (a ? "" : "[múlt] ") + "[" + ah[this.day()] + "] LT[-kor]";
  }
  //! moment.js locale configuration
  //! locale : Icelandic [is]
  ...
  function Qd(a, b, c, d) {
    ...
    return 1 === a
      ? e + Nd(a, b, c[0], d)
      : b
      ? e + (Od(a) ? Pd(c)[1] : Pd(c)[0])
      : d
      ? e + Pd(c)[1]
      : e + (Od(a) ? Pd(c)[1] : Pd(c)[2]);
  }
  /**
  ...
  // LOCALES
  var hf = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
    jf = "January_February_March_April_May_June_July_August_September_October_November_December".split(
      "_"
    ),
  ...
  U("Y", 0, 0, function() {
    ...
    ba("YYYY", function(b, c) {
      c[Ze] = 2 === b.length ? a.parseTwoDigitYear(b) : u(b);
    }),
    ba("YY", function(b, c) {
      c[Ze] = a.parseTwoDigitYear(b);
    }),
    ba("Y", function(a, b) {
      b[Ze] = parseInt(a, 10);
    }),
  ...
  // LOCALES
  var pf = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split(
      "_"
    ),
  ...
  (Vf.add = Nf),
    ...
    // Week
    (Vf.week = Vf.weeks = Ba),
    (Vf.isoWeek = Vf.isoWeeks = Ca),
    (Vf.weeksInYear = Dc),
    (Vf.isoWeeksInYear = Cc),
    // Day
    (Vf.date = Qf),
    (Vf.day = Vf.days = Ka),
    (Vf.weekday = La),
    ...
    (Vf.zoneName = Kc),
    // Deprecations
    (Vf.dates = x("dates accessor is deprecated. Use date instead.", Qf)),
    (Vf.months = x("months accessor is deprecated. Use month instead", ka)),
    (Vf.years = x("years accessor is deprecated. Use year instead", nf)),
    (Vf.zone = x(
  ...
  (Wf.calendar = D),
    ...
    (Wf.monthsParse = ia),
    (Wf.monthsRegex = na),
    (Wf.monthsShortRegex = ma),
    // Week
    (Wf.week = ya),
    (Wf.firstDayOfYear = Aa),
    (Wf.firstDayOfWeek = za),
    // Day of Week
    (Wf.weekdays = Fa),
    (Wf.weekdaysMin = Ha),
    (Wf.weekdaysShort = Ga),
    (Wf.weekdaysParse = Ja),
    (Wf.weekdaysRegex = Na),
    (Wf.weekdaysShortRegex = Oa),
    (Wf.weekdaysMinRegex = Pa),
    // Hours
    (Wf.isPM = Va),
    (Wf.meridiem = Wa),
    $a("en", {
  ...
  var Hg = "leden_únor_březen_duben_květen_červen_červenec_srpen_září_říjen_listopad_prosinec".split(
      "_"
    ),
  ...
  var Lg = "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split(
      "_"
    ),
  ...
  var Ng = "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split(
      "_"
    ),
  ...
  a.defineLocale("es", {
    ...
    monthsShort: function(a, b) {
      return /-MMM-/.test(b) ? Og[a.month()] : Ng[a.month()];
    },
    monthsParseExact: !0,
    weekdays: "domingo_lunes_martes_miércoles_jueves_viernes_sábado".split("_"),
    weekdaysShort: "dom._lun._mar._mié._jue._vie._sáb.".split("_"),
  ...
  var Tg = "jan._feb._mrt._apr._mai_jun._jul._aug._sep._okt._nov._des.".split(
      "_"
    ),
    ...
    translate: function(a, b, c) {
      ...
      return 1 === c.length
        ? b
          ? d[0]
          : d[1]
        : a + " " + fh.correctGrammaticalCase(a, d);
    }
  };
  a.defineLocale("me", {
  ...
  var mh = "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split(
      "_"
    ),
  ...
  a.defineLocale("nl-be", {
    ...
    monthsShort: function(a, b) {
      return /-MMM-/.test(b) ? nh[a.month()] : mh[a.month()];
    },
    monthsRegex: ph,
    monthsShortRegex: ph,
  ...
  //! author : Joris Röling : https://github.com/jorisroling
  //! author : Jacob Middag : https://github.com/middagj
  var qh = "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split(
      "_"
    ),
  ...
  a.defineLocale("nl", {
    ...
    monthsShort: function(a, b) {
      return /-MMM-/.test(b) ? rh[a.month()] : qh[a.month()];
    },
    monthsRegex: th,
    monthsShortRegex: th,
    monthsStrictRegex: /^(januari|februari|maart|mei|ju[nl]i|april|augustus|september|oktober|november|december)/i,
  ...
  var wh = "styczeń_luty_marzec_kwiecień_maj_czerwiec_lipiec_sierpień_wrzesień_październik_listopad_grudzień".split(
      "_"
    ),
    xh = "stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_września_października_listopada_grudnia".split(
      "_"
    );
  a.defineLocale("pl", {
    months: function(a, b) {
      return "" === b
        ? "(" + xh[a.month()] + "|" + wh[a.month()] + ")"
        : /D MMMM/.test(b)
        ? xh[a.month()]
        : wh[a.month()];
    },
  ...
  var zh = "január_február_marec_apríl_máj_jún_júl_august_september_október_november_december".split(
      "_"
    ),
