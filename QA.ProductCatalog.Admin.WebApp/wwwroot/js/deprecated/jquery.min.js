...
(function(n, t) {
  ...
  function pu(n, t) {
    if (t in n) return t;
    for (
      var r = t.charAt(0).toUpperCase() + t.slice(1), u = t, i = yu.length;
      i--;
  ...
  function du(n, t, u) {
    ...
    if (f <= 0 || f == null) {
      if (
        ((f = d(n, t, e)), (f < 0 || f == null) && (f = n.style[t]), pt.test(f))
      )
        return f;
  ...
  p = (function(n) {
    ...
    function wi(n, t) {
      var i = t && n,
        r =
          ...
          n.nodeType === 1 &&
          t.nodeType === 1 &&
          (~t.sourceIndex || ai) - (~n.sourceIndex || ai);
      if (r) return r;
        ...
        : ((e = r),
          ...
          (u.qsa = st.test(r.querySelectorAll)) &&
            (c(function(n) {
              ...
              n.querySelectorAll("[msallowclip^='']").length &&
                o.push("[*^$]=" + i + "*(?:''|\"\")");
                ...
                return i
                  ...
                  : ((i =
                      (n.ownerDocument || n) === (t.ownerDocument || t)
                        ...
                        : 1),
                    i & 1 ||
                      (!u.sortDetached && t.compareDocumentPosition(n) === i))
    ...
    r.attr = function(n, i) {
      ...
      var f = t.attrHandle[i.toLowerCase()],
        r =
          f && di.call(t.attrHandle, i.toLowerCase()) ? f(n, i, !a) : undefined;
      return r !== undefined
        ? r
        : u.attributes || !a
        ? n.getAttribute(i)
                ...
                if (p) {
                  if (s) {
                    while (b) {
                      for (c = t; (c = c[b]); )
                        if (
                          e ? c.nodeName.toLowerCase() === g : c.nodeType === 1
                        )
                          return !1;
    ...
    return (
      ...
      (si = r.select = function(n, i, r, f) {
        ...
        return (
          (c || wt(n, h))(f, i, !a, r, (gt.test(n) && ii(i.parentNode)) || i), r
        );
      }),
      (u.sortStable =
        f
  ...
  i.fn.extend({
    ...
    is: function(n) {
      return !!ui(this, typeof n == "string" && fr.test(n) ? i(n) : n || [], !1)
        .length;
    }
  });
  var ft,
    ...
    closest: function(n, t) {
      for (
        var r,
          ...
          o = this.length,
          u = [],
          e = fr.test(n) || typeof n != "string" ? i(n, t || this.context) : 0;
        f < o;
        f++
      )
  ...
  i.extend({
    ...
    hasData: function(n) {
      return (
        (n = n.nodeType ? i.cache[n[i.expando]] : n[i.expando]), !!n && !ei(n)
      );
    },
    data: function(n, t, i) {
      return pr(n, t, i);
      ...
      function c() {
        ...
        ((r = u.getElementsByTagName("body")[0]), r && r.style) &&
          ...
          n.getComputedStyle &&
            ...
            (s =
              (n.getComputedStyle(i, null) || { width: "4px" }).width ===
              "4px"),
    ...
    val: function(n) {
      ...
      return arguments.length
        ...
        ? ((t = i.valHooks[u.type] || i.valHooks[u.nodeName.toLowerCase()]),
          ...
          ? r
          : ((r = u.value),
            typeof r == "string" ? r.replace(uf, "") : r == null ? "" : r)
        : void 0;
    }
  });
  i.extend({
  ...
  i.extend({
    ...
    ajax: function(n, t) {
      ...
      r.hasContent ||
        (r.data &&
          ((f = r.url += (wi.test(f) ? "&" : "?") + r.data), delete r.data),
        r.cache === !1 &&
          (r.url = sf.test(f)
            ? f.replace(sf, "$1_=" + pi++)
            : f + (wi.test(f) ? "&" : "?") + "_=" + pi++));
          ...
          return ((t = e.documentElement), !i.contains(t, r))
            ...
            : (typeof r.getBoundingClientRect !== o &&
              ...
              (f = wf(e)),
              {
                ...
                left:
                  u.left + (f.pageXOffset || t.scrollLeft) - (t.clientLeft || 0)
              });
      },
      position: function() {
        if (this[0]) {
