  ...
  (function(n) {
    ...
    (function(n) {
      ...
      function W(a, c) {
        ...
        e.S ||
          (this.lb && this.Ma[c]
            ? (d.Qb(c, a, this.Ma[c]), (this.Ma[c] = null), --this.lb)
            : e.r[c] || d.Qb(c, a, e.s ? { ia: a } : d.wc(a)));
      }
      function K(b, c, d, e) {
        a.d[b] = {
              ...
              function() {
                ...
                if (A || c || p !== k)
                  A && a.va.Aa() && (r = a.a.ua(a.f.childNodes(b), !0)),
                    p
                      ? (A || a.f.da(b, a.a.ua(r)), a.eb(e ? e(m, q) : m, b))
                      : a.f.xa(b),
                    (k = p);
              },
              null,
      ...
      a.a = (function() {
        ...
        var f = { __proto__: [] } instanceof Array,
          ...
          l = {};
        h[
          M && /Firefox\/2/i.test(M.userAgent) ? "KeyboardEvent" : "UIEvents"
        ...
        return {
          ...
          lc: function(b) {
            b = a.a.V(b);
            for (
              var c = ((b[0] && b[0].ownerDocument) || s).createElement("div"),
                d = 0,
                e = b.length;
              d < e;
              d++
          ...
          sc: function(b, c) {
            ...
            if (0 < d.length) {
              for (
                var e = d[0], k = e.parentNode, m = 0, f = c.length;
                m < f;
                m++
              )
            ...
            if (a.options.useOnlyNativeEvents || !u || d)
              if ("function" == typeof s.createEvent)
                if ("function" == typeof b.dispatchEvent)
                  (d = s.createEvent(l[c] || "HTMLEvents")),
                    d.initEvent(
                      c,
                      !0,
                      !0,
          ...
          tc: function(a, b) {
            ...
            if (7 >= k)
              try {
                a.mergeAttributes(
                  s.createElement("<input name='" + a.name + "'/>"),
                  !1
                );
              } catch (c) {}
          },
      ...
      a.Ba = function(b) {
        return ("function" == typeof b && b[H] === a.N) ||
          ("function" == typeof b && b[H] === a.B && b.Wc)
          ? !0
          : !1;
      };
      a.b("observable", a.N);
      ...
      a.a.q("pop push reverse shift sort splice unshift".split(" "), function(
        b
      ) {
        a.la.fn[b] = function() {
          var a = this.t();
      ...
      var z = {
          ...
          cc: function() {
            ...
            c && 0 <= c
              ? (clearTimeout(this[t].dc),
                (this[t].dc = a.a.setTimeout(function() {
                  b.aa(!0);
                }, c)))
              : b.Fa
              ? b.Fa()
          ...
          Rc: function(b) {
            var c = this[t],
              d = !1,
              e = c.Va ? n : !c.L,
              f = { Ic: this, Ma: c.r, lb: c.L };
            a.l.Vb({ Hc: f, gb: W, m: this, Sa: e });
            c.r = {};
            c.L = 0;
            f = this.Qc(c, f);
            this.tb(c.U, f) &&
              (c.s || this.notifySubscribers(c.U, "beforeChange"),
              (c.U = f),
      ...
      (function() {
        ...
        9 > a.a.C &&
          ...
          (s.createDocumentFragment = (function(b) {
            return function() {
              var c = b(),
                f = a.g.Cc,
                g;
            ...
            function e() {
              ...
              if (!a.va.Sa() && (!l || e)) {
                ...
                if (k) {
                  var m = r ? h.t() : h;
                  q !== f
                    ? (e && (a.a.pa(m, f, !0), a.a.pa(m, q, !1)), (q = f))
                    : a.a.pa(m, f, e);
                  r && a.Ba(h) && h(m);
      ...
      (function() {
        ...
        a.d.template = {
          ...
          update: function(b, c, d, e, f) {
            ...
            "foreach" in c
              ? (e = a.ld(g || b, (d && c.foreach) || [], c, b, f))
              : d
              ? ((f = "data" in c ? f.Zb(c.data, c.as) : f),
                (e = a.Ab(g || b, f, c, b)))
              : a.f.xa(b);
            f = e;
        ...
        a.h.ta.template = function(b) {
          b = a.h.yb(b);
          return (1 == b.length && b[0].unknown) || a.h.bd(b, "name")
            ? null
          ...
          var m = [],
            k = a.B(
              function() {
                ...
                0 < m.length && (a.a.sc(m, k), h && a.l.w(h, null, [d, k, l]));
                m.length = 0;
                a.a.ra(m, k);
              },
              null,
