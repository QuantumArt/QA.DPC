...
!(function(n, t) {
  ...
  return (
    ...
    i.ajaxPrefilter("json jsonp", function(t, r, f) {
      ...
      if (h || "jsonp" === t.dataTypes[0])
        return (
          (e = t.jsonpCallback = u(t.jsonpCallback)
            ? t.jsonpCallback()
            : t.jsonpCallback),
          h
    ...
    (i.parseHTML = function(n, t, r) {
      return "string" != typeof n
        ...
        : ("boolean" == typeof t && ((r = t), (t = !1)),
          t ||
            (e.createHTMLDocument
              ? (((s = (t = f.implementation.createHTMLDocument(
                  ""
                )).createElement("base")).href = f.location.href),
  ...
  (function(n) {
    ...
    function i(t) {
      return n.isFunction(t) || n.isPlainObject(t) ? t : { top: t, left: t };
    }
