...
(function(a) {
  ...
  function e(b, e) {
    ...
    a.extend(e, {
      ...
      beforeSend: function(d) {
        var a;
        f(d, g);
        a = c(b.getAttribute("data-ajax-begin"), ["xhr"]).apply(
          this,
          arguments
        );
        a !== false && k.show(i);
      ...
      complete: function() {
        k.hide(i);
        c(b.getAttribute("data-ajax-complete"), ["xhr", "status"]).apply(
          this,
          arguments
        );
      },
      success: function(a, e, d) {
        ...
        c(b.getAttribute("data-ajax-success"), ["data", "status", "xhr"]).apply(
          this,
          arguments
        );
      },
  ...
  a(document).on("click", "form[data-ajax=true] input[type=image]", function(
    c
  ) {
    var g = c.target.name,
      d = a(c.target),
