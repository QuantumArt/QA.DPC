import { isIsoDateString, isString } from "ProductEditor/Utils/TypeChecks";
import { isEntityObject, ArticleObject, EntityObject } from "ProductEditor/Models/EditorDataModels";
import {
  ContentSchema,
  isExtensionField,
  UpdatingMode,
