...
namespace QA.Core.DPC.Loader.Tests
{
    ...
    public class ProductSerializationTests
    {
        ...
        public void TestXmlDeserialization()
        {
            ...
            File.ReadAllText("TestData\\ReferenceDto.xaml", Encoding.GetEncoding("windows-1251"));
        }
        ...
        public void TextJsonDeserialization()
        {
            ...
            var referenceXaml = File.ReadAllText("TestData\\ReferenceDto.xaml", Encoding.GetEncoding("windows-1251"));
        ...
        {
            var xaml = File.ReadAllText("TestData\\ReferenceDto.xaml", Encoding.GetEncoding("windows-1251"));
