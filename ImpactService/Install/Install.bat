...
PowerShell -NoProfile -ExecutionPolicy Bypass -Command "& {Start-Process PowerShell -ArgumentList '-NoProfile -ExecutionPolicy Bypass -File """"%PowerShellScriptPath%"""" -logPath """"C:\QA\Logs"""" -elasticUrl """"%ElasticUrl%"""" -liveIndexName """"%CustomerCode%%LiveSuff%"""" -stageIndexName """"%CustomerCode%%StageSuff%""""' -Verb RunAs}";
